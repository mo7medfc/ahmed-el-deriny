...
export const STAMP_FLYER_OPTIONS: StampFlyerOption[] = [
  {
    id: "wood-hand",
    nameAr: "ختم يد خشب 2.2 × 5.5",
    nameEn: "Wooden hand stamp 2.2 × 5.5",
    price: 140,
  ...
  {
    id: "auto-small",
    nameAr: "ختم أتوماتيك صغير 1 × 3",
    nameEn: "Small automatic stamp 1 × 3",
    price: 155,
  ...
  {
    id: "auto-medium",
    nameAr: "ختم أتوماتيك وسط 1.5 × 4",
    nameEn: "Medium automatic stamp 1.5 × 4",
    price: 160,
  ...
  {
    id: "auto-large",
    nameAr: "ختم أتوماتيك كبير 2.2 × 5.5",
    nameEn: "Large automatic stamp 2.2 × 5.5",
    price: 165,

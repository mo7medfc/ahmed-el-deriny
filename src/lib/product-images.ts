...
const RULES: ImageRule[] = [
  ...
  {
    test: (t) => /acrylic-white|أكريليك\s*أبيض|لوحة\s*أكريليك\s*أبيض/i.test(t),
    image: `${BASE}/acrylic-white.png`,
    altAr: "لوحة أكريليك أبيض",
    altEn: "White acrylic board",
  },
  {
    test: (t) => /acrylic-clear|أكريليك\s*شفاف/i.test(t),
    image: `${BASE}/acrylic-clear.png`,
    altAr: "أكريليك شفاف مطبوع ألوان",
    altEn: "Clear acrylic full color print",
  },
  {
    test: (t) => /acrylic-gold|nameplate-gold|باغة\s*ذهب/i.test(t),
    image: `${BASE}/acrylic-gold.png`,
    altAr: "باغة ذهبى أكريليك",
    altEn: "Gold acrylic sheet",
  },
  {
    test: (t) => /acrylic-silver|nameplate-silver|باغة\s*فض/i.test(t),
    image: `${BASE}/acrylic-silver.png`,
    altAr: "باغة فضى أكريليك",
    altEn: "Silver acrylic sheet",
  },
  {
    test: (t) => /acrylic|nameplate|باغة|لوحات\s*إرشادية/i.test(t),
    image: `${BASE}/acrylic-sheets-composite.png`,
    altAr: "شرائح أكريليك للوحات الإرشادية",
    altEn: "Acrylic sheets for wayfinding signs",
  },
  {

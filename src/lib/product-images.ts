...
export const categoryImages: Record<string, string> = {
  ...
  "appreciation-certificates": `${BASE}/cert-cover-ribbon.jpg`,
...
const RULES: ImageRule[] = [
  ...
  {
    test: (t) => /cert-cover-ribbon|فيونكة/i.test(t),
    image: `${BASE}/cert-cover-ribbon.jpg`,
    altAr: "كافر فيونكة بالشهادة",
    altEn: "Ribbon bow certificate cover",
  },
  {
    test: (t) => /cert-cover-wood|كافر\s*خشب/i.test(t),
    image: `${BASE}/cert-cover-wood.jpg`,
    altAr: "كافر خشب بالشهادة",
    altEn: "Wooden certificate cover",
  },
  {
    test: (t) => /cert-cover-grad|كاب\s*تخرج/i.test(t),
    image: `${BASE}/cert-cover-grad-cap.jpg`,
    altAr: "كافر كاب تخرج بالشهادة",
    altEn: "Graduation certificate cover",
  },
  {
    test: (t) => /cert-cover-stamp|بالبصمة/i.test(t),
    image: `${BASE}/cert-cover-stamp.jpg`,
    altAr: "كافر بالبصمة بالشهادة",
    altEn: "Embossed certificate cover",
  },
  {
    test: (t) => /cert-cover-frame|برواز/i.test(t),
    image: `${BASE}/cert-cover-frame.jpg`,
    altAr: "كافر برواز بصمة بالشهادة",
    altEn: "Framed certificate cover",
  },
  {
    test: (t) => /cert-cover-tassel|شريطة/i.test(t),
    image: `${BASE}/cert-cover-tassel.jpg`,
    altAr: "كافر شريطة بالشهادة",
    altEn: "Tassel certificate cover",
  },
  {
    test: (t) => /appreciation|شهادة\s*تقدير|شهادات\s*تقدير|كافر/i.test(t),
    image: `${BASE}/cert-cover-ribbon.jpg`,
    altAr: "شهادة تقدير",

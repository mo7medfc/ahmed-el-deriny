...
> = {
  ...
  DeskBases: { nameAr: "قاعدات المكتب", nameEn: "Desk Bases", icon: "award", sortOrder: 8, editorType: "unit" },
  AppreciationCertificates: { nameAr: "شهادات التقدير", nameEn: "Appreciation Certificates", icon: "award", sortOrder: 9, editorType: "unit" },
  Nameplates: { nameAr: "باغة محفور عليها الاسم", nameEn: "Engraved Nameplates", icon: "badge", sortOrder: 10, editorType: "unit" },
